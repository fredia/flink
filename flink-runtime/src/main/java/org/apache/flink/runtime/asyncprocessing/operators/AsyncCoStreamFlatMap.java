 ...
 */
@Internal
public class AsyncCoStreamFlatMap<IN1, IN2, OUT>
        extends AbstractAsyncStateUdfStreamOperator<OUT, CoFlatMapFunction<IN1, IN2, OUT>>
    ...
    public AsyncCoStreamFlatMap(CoFlatMapFunction<IN1, IN2, OUT> flatMapper) {
        super(flatMapper);
    }
