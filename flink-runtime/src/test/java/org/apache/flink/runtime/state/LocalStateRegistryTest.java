...
/** {@link LocalStateRegistry}'s test. */
public class LocalStateRegistryTest extends TestLogger {

    @Test
    public void testRegistryNormal() {
        LocalStateRegistry localStateRegistry = new LocalStateRegistry(Executors.directExecutor());
        ...
        localStateRegistry.unRegister(2);
        assertTrue(handle1.isDisposed());
        assertFalse(handle2.isDisposed());

        localStateRegistry.unRegister(3);
