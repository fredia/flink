...
import static org.apache.flink.streaming.examples.wordcount2.JobConfig.ENABLE_CLAIM;
...
import static org.apache.flink.streaming.examples.wordcount2.JobConfig.RESTORE_PATH;
...
public class WordCount {
	...
	public static void main(String[] args) throws Exception {
        ...
        if (configuration.getOptional(RESTORE_PATH).isPresent()) {
            configuration.set(SAVEPOINT_PATH, configuration.get(RESTORE_PATH));
        }
