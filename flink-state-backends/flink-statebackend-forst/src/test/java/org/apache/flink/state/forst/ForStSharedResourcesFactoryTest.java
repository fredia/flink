...
import static org.apache.flink.state.forst.ForStMemoryControllerUtils.calculateWriteBufferManagerCapacity;
import static org.apache.flink.state.forst.ForStOptions.FIX_PER_SLOT_MEMORY_SIZE;
import static org.apache.flink.state.forst.ForStOptions.FIX_PER_TM_MEMORY_SIZE;
import static org.apache.flink.state.forst.ForStOptions.USE_MANAGED_MEMORY;
import static org.apache.flink.state.forst.ForStOptions.WRITE_BUFFER_RATIO;
import static org.apache.flink.state.forst.ForStSharedResourcesFactory.SLOT_SHARED_MANAGED;
import static org.apache.flink.state.forst.ForStSharedResourcesFactory.SLOT_SHARED_UNMANAGED;
import static org.apache.flink.state.forst.ForStSharedResourcesFactory.TM_SHARED_UNMANAGED;
import static org.apache.flink.util.CollectionUtil.entry;
import static org.apache.flink.util.CollectionUtil.map;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.params.provider.Arguments.arguments;

/** {@link ForStSharedResourcesFactory} test. */
public class ForStSharedResourcesFactoryTest {
    private static final Logger LOG =
            LoggerFactory.getLogger(ForStSharedResourcesFactoryTest.class);

    @TempDir static Path tempDir;

    @BeforeAll
    static void init() throws IOException {
        ForStStateBackend.ensureForStIsLoaded(tempDir.toAbsolutePath().toString());
    }
    ...
    public void testSelectionStrategy(
            ...
            ForStSharedResourcesFactory expected)
            throws IOException {
        ...
        assertEquals(
                expected,
                ForStSharedResourcesFactory.from(
                        ForStMemoryConfiguration.fromConfiguration(jobConfig), getEnv(tmConfig)));
    }
    ...
    public void testTmSharedMemorySize() throws Exception {
        ...
        OpaqueMemoryResource<ForStSharedResources> resource =
                TM_SHARED_UNMANAGED.create(
                        ForStMemoryConfiguration.fromConfiguration(new Configuration()),
                        getEnv(tmConfig),
                        0, // managed memory fraction must be ignored
                        LOG,
                        ForStMemoryControllerUtils.ForStMemoryFactory.DEFAULT);
