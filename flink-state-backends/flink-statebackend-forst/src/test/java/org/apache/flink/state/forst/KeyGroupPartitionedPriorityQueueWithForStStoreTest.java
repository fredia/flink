 ...
 */
class KeyGroupPartitionedPriorityQueueWithForStStoreTest extends InternalPriorityQueueTestBase {

    @RegisterExtension public final ForStExtension forStExtension = new ForStExtension();
    ...
    private KeyGroupPartitionedPriorityQueue.PartitionQueueSetFactory<
                    TestElement, ForStCachingPriorityQueueSet<TestElement>>
            newFactory() {
        ...
        return (keyGroupId, numKeyGroups, keyExtractorFunction, elementComparator) -> {
            ...
            return new ForStCachingPriorityQueueSet<>(
                    ...
                    forStExtension.getReadOptions(),
                    forStExtension.getDefaultColumnFamily(),
                    TestElementSerializer.INSTANCE,
                    outputStreamWithPos,
                    inputStreamWithPos,
                    forStExtension.getBatchWrapper(),
                    orderedSetCache);
        };
    }
}
