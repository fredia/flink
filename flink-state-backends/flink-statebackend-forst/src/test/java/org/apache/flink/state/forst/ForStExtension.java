...
public class ForStExtension implements BeforeEachCallback, AfterEachCallback {
    ...
    /** Wrapper for batched writes to the ForSt instance. */
    private ForStWriteBatchWrapper batchWrapper;
    ...
    public ForStWriteBatchWrapper getBatchWrapper() {
        return batchWrapper;
    }
    ...
    public void before() throws Exception {
        ...
        this.db =
                RocksDB.open(
                        ...
                        columnFamilyHandles);
        this.batchWrapper = new ForStWriteBatchWrapper(db, writeOptions);
    }
