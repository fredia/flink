...
import static org.apache.flink.state.forst.ForStKeyedStateBackend.MERGE_OPERATOR_NAME;
...
public class ForStOperationUtils {
    ...
    public static void registerKvStateInformation(
            ...
            ForStKeyedStateBackend.ForStKvStateInfo registeredColumn) {
     ...
     */
    public static ForStKeyedStateBackend.ForStKvStateInfo createStateInfo(
            RegisteredStateMetaInfoBase metaInfoBase,
            RocksDB db,
            Function<String, ColumnFamilyOptions> columnFamilyOptionsFactory,
            @Nullable ForStTtlCompactFiltersManager ttlCompactFiltersManager,
        ...
        return new ForStKeyedStateBackend.ForStKvStateInfo(columnFamilyHandle, metaInfoBase);
    }
