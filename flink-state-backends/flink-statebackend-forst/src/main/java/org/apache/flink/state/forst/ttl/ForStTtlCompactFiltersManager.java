...
package org.apache.flink.state.forst.ttl;
...
/** ForSt compaction filter utils for state with TTL. */
public class ForStTtlCompactFiltersManager {
    ...
    public ForStTtlCompactFiltersManager(TtlTimeProvider ttlTimeProvider) {
