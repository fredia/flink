...
import static org.apache.flink.state.forst.ForStStateBackend.PriorityQueueStateType.FORST;
import static org.apache.flink.state.forst.PredefinedOptions.DEFAULT;
import static org.apache.flink.state.forst.PredefinedOptions.FLASH_SSD_OPTIMIZED;
import static org.apache.flink.state.forst.PredefinedOptions.SPINNING_DISK_OPTIMIZED;
import static org.apache.flink.state.forst.PredefinedOptions.SPINNING_DISK_OPTIMIZED_HIGH_MEM;

/** Configuration options for the ForSt backend. */
@PublicEvolving
public class ForStOptions {

    /** The local directory (on the TaskManager) where ForSt puts its files. */
            ...
            ConfigOptions.key("state.backend.forst.timer-service.cache-size")
                    ...
                    .withDescription(
                            String.format(
                                    ...
                                    TIMER_SERVICE_FACTORY.key(), FORST.name()));
    ...
    /** The predefined settings for ForSt DBOptions and ColumnFamilyOptions by Flink community. */
    public static final ConfigOption<String> PREDEFINED_OPTIONS =
            ConfigOptions.key("state.backend.forst.predefined-options")
                    .stringType()
